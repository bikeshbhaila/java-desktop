...
public class BankControllerMYSQL implements BankControllerInterface {
    ...
    public boolean newAccount(Account a) {
        // CHECK if the account number already exist in the system or not?
    ...
    public int deleteAccount(int accNo) {
        ...
        if(a != null){
            if(a.getAmount() == 0){
                ...
                return -2; // because there was some money reamining in the account.
            }
        } else {
            return 0; // becase account was not found.
        }
    }
